try:
    ...
    print("Warning: paramiko not available, remote communication features will be disabled")
...
class Communicator:
    def __init__(self, host, port, username, password):
        if not PARAMIKO_AVAILABLE:
            ...
            self.ssh = None
            self.sftp = None
            self.error_msg = "paramiko not available"
            print('Failed creating communicator: paramiko not available')
            return
